...
$specialization = $description = $specializationErr = "";
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($specializationErr == "") {
        $sql = "INSERT INTO `specializations` (`specialization`, `description`) VALUES ('$specialization', '$description')";
                            ...
                            <div class="card-body card-block">
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="text-input" class=" form-control-label">specialization</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="specialization" placeholder="Enter specialization" class="form-control" value="<?php echo $specialization; ?>" required>
                                        <small class="text-danger Invalid Feedback"><?php echo $specializationErr; ?></small>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
