...
<head>
  ...
  <title>MySchool - Welcome <?php echo $_SESSION['admin_name'] ?></title>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.php" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">MySchool</span>
      </a>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              ...
              <span><?php echo strtoupper($_SESSION['admin_type']); ?></span>
            </li>
            <li>
              <hr class="dropdown-divider">
            </li>
        ...
        <ul id="cities-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
          <li>
            <a href="cities.php" class="active">
              <i class="bi bi-circle"></i><span>Show All Cities</span>
            </a>
          </li>
          <li>
            <a href="addnewcity.php">
              <i class="bi bi-circle"></i><span>Add New City</span>
            </a>
          </li>
        </ul>
      </li><!-- End Cities Nav -->
        ...
        <ul id="teachers-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
          <li>
            <a href="teachers.php" class="active">
              <i class="bi bi-circle"></i><span>Show All Teachers</span>
            </a>
          </li>
          <li>
        ...
        <ul id="students-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
          <li>
            <a href="students.php" class="active">
              <i class="bi bi-circle"></i><span>Show All Students</span>
            </a>
          </li>
          <li>
